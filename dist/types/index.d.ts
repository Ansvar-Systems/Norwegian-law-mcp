...
export type { EUDocumentType, EUCommunity, ReferenceType, ImplementationStatus, EUDocument, EUReference, EUBasisDocument, NorwegianImplementation, SwedishImplementation, ProvisionEUReference, } from './eu-references.js';
