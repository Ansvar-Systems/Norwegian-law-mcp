...
import { getPreparatoryWorks } from './get-preparatory-works.js';
...
import { getNorwegianImplementations } from './get-norwegian-implementations.js';
        ...
        try {
            ...
            switch (name) {
                ...
                case 'search_case_law':
                    result = await searchCaseLaw(db, args);
                    break;
                case 'get_preparatory_works':
                    result = await getPreparatoryWorks(db, args);
                    break;
                ...
                case 'get_norwegian_implementations':
                    result = await getNorwegianImplementations(db, args);
                    break;
