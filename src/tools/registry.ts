...
import { getNorwegianImplementations, GetNorwegianImplementationsInput } from './get-swedish-implementations.js';
...
Specify the LOV id and either chapter+section or provision_ref directly.`,
  ...
  },
  {
    ...
    description: `Search Norwegian court decisions (rattsfall). Filter by court (HD, HFD, AD, etc.) and date range.`,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: `Get preparatory works (forarbeten) for a Norwegian statute. Returns linked propositions, SOUs, and Ds documents.`,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: `Validate a Norwegian legal citation against the database. Parses the citation, checks existence, and returns warnings.`,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: `Format a Norwegian legal citation per standard conventions (full, short, or pinpoint).`,
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        sfs_number: { type: 'string', description: 'LOV id (e.g., "LOV-2018-06-15-38")' },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_swedish_implementation: { type: 'boolean', description: 'Legacy alias for has_norwegian_implementation' },
