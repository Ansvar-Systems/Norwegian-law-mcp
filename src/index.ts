...
import { getNorwegianImplementations, GetNorwegianImplementationsInput } from './tools/get-swedish-implementations.js';
...
const TOOLS: Tool[] = [
  {
    ...
    description: `Search Norwegian statutes and regulations by keyword.
...
Returns matched provisions with snippets, relevance scores, and document metadata.`,
    inputSchema: {
      ...
      properties: {
        ...
        document_id: {
          type: 'string',
          description: 'Filter to a specific statute by LOV id (e.g., "LOV-2018-06-15-38")',
        },
        status: {
          type: 'string',
  ...
  {
    name: 'get_provision',
    description: `Retrieve a specific provision from a Norwegian statute.

Specify the LOV id and either chapter+section or provision_ref directly.
Examples:
  - document_id="LOV-2018-06-15-38", chapter="1", section="1" → Kapittel 1 § 1
  - document_id="LOV-2018-06-15-38", provision_ref="1:1" → same result
  - document_id="LOV-1967-02-10", section="5" → § 5 (flat statute, no chapter)
...
Omit chapter/section/provision_ref to get all provisions in the statute.`,
    inputSchema: {
      ...
      properties: {
        document_id: {
          type: 'string',
          description: 'LOV id (e.g., "LOV-2018-06-15-38")',
        },
        chapter: {
          type: 'string',
  ...
  },
  {
    ...
    description: `Search Norwegian court decisions (rattsfall).
...
Searches case summaries and keywords. Filter by court (HD, HFD, AD, etc.) and date range.`,
  ...
  },
  {
    ...
    description: `Get preparatory works (forarbeten) for a Norwegian statute.
...
Essential for understanding legislative intent behind statutory provisions.`,
    inputSchema: {
      ...
      properties: {
        document_id: {
          type: 'string',
          description: 'LOV id of the statute (e.g., "LOV-2018-06-15-38")',
        },
      },
      required: ['document_id'],
    },
  },
  {
    ...
    description: `Validate a Norwegian legal citation against the database.
...
Searches across statutes, case law, and preparatory works simultaneously to aggregate relevant citations. Use this for broad legal research questions.`,
  ...
  },
  {
    ...
    description: `Format a Norwegian legal citation per standard conventions.

Formats:
  - full: "LOV LOV-2018-06-15-38 3 kap. 5 §"
  ...
  {
    name: 'check_currency',
    description: `Check if a Norwegian statute or provision is in force (current or historical).
...
Returns the document's status (in_force, amended, repealed, not_yet_in_force), dates, and warnings. Provide as_of_date for historical evaluation.`,
  ...
  {
    name: 'get_eu_basis',
    description: `Get EU legal basis (directives and regulations) for a Norwegian statute.
...
Essential for understanding which EU law a Norwegian statute is based on.`,
    inputSchema: {
      type: 'object',
      properties: {
        sfs_number: {
          type: 'string',
          description: 'LOV number (e.g., "2018:218")',
        },
        include_articles: {
          type: 'boolean',
  ...
  },
  {
    ...
    description: `Find Norwegian statutes implementing a specific EU directive or regulation.

Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns all Norwegian statutes that implement, supplement, or reference it. Shows implementation status and which articles are referenced.

Essential for finding Norwegian law corresponding to EU requirements.`,
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description: `Search for EU directives and regulations with Norwegian implementation information.

Search by keyword, type, year range, or community. Returns matching EU documents with counts of Norwegian statutes referencing them.
...
Use this for exploratory searches like "data protection" or "privacy" to find relevant EU law.`,
    inputSchema: {
      ...
      properties: {
        ...
        has_norwegian_implementation: {
          type: 'boolean',
          description: 'Filter by Norwegian implementation existence',
        },
        has_swedish_implementation: {
          type: 'boolean',
          description: 'Legacy alias for has_norwegian_implementation',
        },
        limit: {
          type: 'number',
  ...
  },
  {
    ...
    description: `Get EU legal basis for a specific provision within a Norwegian statute.
...
Use this for pinpoint EU compliance checks at the provision level.`,
  ...
  },
  {
    ...
    description: `Validate EU compliance status for a Norwegian statute or provision.
  ...
  try {
    ...
    switch (name) {
      ...
      case 'get_norwegian_implementations':
        result = await getNorwegianImplementations(getDb(), args as unknown as GetNorwegianImplementationsInput);
        break;
