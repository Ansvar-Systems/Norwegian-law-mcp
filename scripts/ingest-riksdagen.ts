#!/usr/bin/env tsx
/**
 * Lovdata Data Ingestion Script
 *
 * Fetches Norwegian statutes from Lovdata's open data API and converts
...
const KNOWN_STATUTES: Record<string, StatuteMetadata> = {
  ...
  '1962:700': {
    short_name: 'BrB',
    title_en: 'The Norwegian Criminal Code',
...
export async function ingest(sfsNumber: string, outputPath: string): Promise<void> {
  ...
  const parseResult = parseLovdataProvisions(rawText);
