#!/usr/bin/env tsx
/**
 * Bulk ingest Norwegian regulations (forskrifter) from official source.
 *
 * Defaults to the full Lovdata catalog (data/relevant-regulations-all.json,
 * generated by `npm run catalog:regulations`).
 *
 * Usage:
 *   npm run ingest:regulations
 *   npm run ingest:regulations -- data/some-other-list.json
 *   npm run ingest:regulations -- data/relevant-regulations-all.json --metadata-only
 */
...
const DEFAULT_CONFIG_PATH = path.resolve(__dirname, '../data/relevant-regulations-all.json');
